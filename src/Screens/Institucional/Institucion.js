        ...
        <div className={styles.container}>
            ...
            <section className={styles.politicas}>
                ...
                <div className={styles.puntos}>
                        ...
                        <p>
                            <h4>01.</h4>Brindar cordialidad y eficacia en la atención personalizada.
                        </p>
                    
                        <p>
                            <h4>02.</h4>Garantizar la realización de los análisis clínicos solicitados.
                        </p>
                    
                        <p>
                            <h4>03.</h4>Entregar resultados confiables en el tiempo y la forma acordada.
                        </p>
                    
                        <p>
                            <h4>04.</h4>Asegurar el liderazgo profesional.
                        </p>
            
                        <p>
                            <h4>05.</h4>Lograr la satisfacción de nuestros pacientes y de las Instituciones que remiten muestras a nuestro laboratorio.
                        </p>
                </div>
